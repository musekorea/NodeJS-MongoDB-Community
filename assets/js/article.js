...
var goodBtn = document.querySelector('#goodBtn');
var badBtn = document.querySelector('#badBtn');
var goodNum = document.querySelector('#goodNum');
var badNum = document.querySelector('#badNum');
...
var addGood = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator_runtime__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
    var currentURL, postID, regex, fetchGood;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return fetch('/community/addGood', {
              method: 'post',
              headers: {
