...
var pwd0 = document.querySelector('#oldPassword');
var pwd1 = document.querySelector('#newPassword1');
var pwd2 = document.querySelector('#newPassword2');
...
var confirmPassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", window.location.replace("/user/changePassword"));

          case 12:
            if (!(pwdFetch.status === 200)) {
              _context.next = 17;
              break;
            }

            _context.next = 15;
            return pwdFetch.json();

          case 15:
            body = _context.sent;
            return _context.abrupt("return", window.location.replace("/user/userProfile/".concat(body.nickname)));
  ...
  return function confirmPassword(_x) {
